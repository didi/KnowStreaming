...
public enum ApiKeys {
    ...
    ENVELOPE(1001, "Envelope", EnvelopeRequestData.SCHEMAS, EnvelopeResponseData.SCHEMAS);
    ...
    ApiKeys(int id, String name, boolean clusterAction, byte minRequiredInterBrokerMagic,
        ...
        boolean forwardable = id == 18 || id == 3 || id == 10 || id == 22;
        this.requiresDelayedAllocation = forwardable || requestRetainsBufferReference;
