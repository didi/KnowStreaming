...
public class RequestContext implements AuthorizableRequestContext {
    ...
    public RequestContext(RequestHeader header,
                          ...
                          SecurityProtocol securityProtocol,
                          ClientInformation clientInformation) {
        this(header, connectionId, clientAddress, -1, principal, listenerName, securityProtocol, clientInformation);
    }
    ...
    public ByteBuffer buildResponseEnvelopePayload(AbstractResponse body) {
        return body.serialize(apiVersion(), header.toResponseHeader());
    }
