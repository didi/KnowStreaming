...
public class BufferResponseData implements ApiMessage {
    private byte[] buffer;
    ...
    public BufferResponseData(Readable _readable, short _version) {
        read(_readable, _version);
    }
    
    public BufferResponseData(Struct struct, short _version) {
        fromStruct(struct, _version);
    }
    
    public BufferResponseData() {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof BufferResponseData)) return false;
        BufferResponseData other = (BufferResponseData) obj;
    ...
    public BufferResponseData setBuffer(byte[] v) {
        this.buffer = v;
        return this;
    }
}
