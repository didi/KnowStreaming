...
class AbstractFetcherThreadTest {
  ...
  def testMetricsRemovedOnShutdown(): Unit = {
    ...
    val fetcherMetrics = Set(FetcherMetrics.BytesPerSec, FetcherMetrics.RequestsPerSec,
      FetcherMetrics.ConsumerLag, FetcherMetrics.RequestTimeMs, FetcherMetrics.TotalTimeMs)
