...
class ReplicaFetcherThread(name: String,
  ...
  override def processPartitionData(topicPartition: TopicPartition,
    ...
    val diskMetrics = KafkaExMetrics.diskTopicPartitionMetrics(logAppendInfo.get.diskName)
    diskMetrics.updateWriteMetrics(topicPartition, records.sizeInBytes, role)
