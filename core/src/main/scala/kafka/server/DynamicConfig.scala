...
object DynamicConfig {
  ...
  object Broker {
    ...
    val DiDiMirrorLeaderThrottledRateProp = "didi.mirror.leader.throttled.rate"
    val DiDiMirrorFollowerThrottledRateProp = "didi.mirror.follower.throttled.rate"

    //Defaults
    val DefaultReplicationThrottledRate = ReplicationQuotaManagerConfig.QuotaBytesPerSecondDefault

    val DefaultMirrorThrottledRate = ReplicationQuotaManagerConfig.QuotaBytesPerSecondDefault
    ...
    val brokerConfigDef = new ConfigDef()
      ...
      .define(DiDiMirrorLeaderThrottledRateProp, LONG, DefaultMirrorThrottledRate, atLeast(0), MEDIUM, "")
      .define(DiDiMirrorFollowerThrottledRateProp, LONG, DefaultMirrorThrottledRate, atLeast(0), MEDIUM, "")
  ...
  object User {
    ...
    private val userConfigs = CredentialProvider.userCredentialConfigs
      ...
      .define(HAUserConfig.DIDI_HA_ACTIVE_CLUSTER_CONFIG, STRING, null, MEDIUM, HAUserConfig.DIDI_HA_ACTIVE_CLUSTER_DOC)
