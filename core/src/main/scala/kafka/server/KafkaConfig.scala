...
object Defaults {
  ...
  val DiDiMirrorNumFetchers: Int = 1
...
object KafkaConfig {
  ...
  val DiDiMirrorSyncAclConfigsIntervalMsProp = "didi.mirror.sync.aclconfigs.interval.ms"
  ...
  private val configDef = {
    ...
    new ConfigDef()
      ...
      .define(MaxSessionsPerUserProp, INT, 2000, MEDIUM, "")
      ...
      .define(DiDiMirrorSyncPartitionsIntervalMsProp, LONG, 10 * 1000L, atLeast(1), HIGH, "")
      .define(DiDiMirrorSyncAclConfigsIntervalMsProp, LONG, 10 * 60 * 1000L, atLeast(1), HIGH, "sync acl and config interval ms")
      .define(DiDiMirrorNumFetchersProp, INT, Defaults.DiDiMirrorNumFetchers, HIGH, "")
...
class KafkaConfig(val props: java.util.Map[_, _], doLog: Boolean, dynamicConfigOverride: Option[DynamicBrokerConfig])
  ...
  var maxSessionsPerUser: Int = getInt(KafkaConfig.MaxSessionsPerUserProp)
  ...
  def mirrorNumFetchers = getInt(KafkaConfig.DiDiMirrorNumFetchersProp)
