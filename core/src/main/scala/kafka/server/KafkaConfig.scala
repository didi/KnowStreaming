...
object KafkaConfig {
  ...
  val GatewayUpdateIntervalProp = "address.update.interval"
  val GatewayMaxNodeConnectionProp = "max.node.connection"
  val GatewayMaxRequestPerClusterProp = "max.request.per.cluster"
  val DiskLoadProtectorEnableProp = "diskloadprotector.enable"
  val SessionReportTimeMsProp = "session.report.ms"
  val KafkaExMetricsEnableAllProp = "kafkaexmetrics.enable"
  val MaxThrottleTimeMsProp = "throttle.max.time.ms"
  val TransmitTimeoutMsProp = "transmit.timout.ms"
  val SaslCheckHostnameEnableProp = "sasl.check.hostname.enable"
  ...
  /** ********* didi Configuration ***********/
  val GatewayUpdateIntervalPropDoc = "gateway update cluster config from km interval mills second"
  val GatewayMaxNodeConnectionPropDoc = "gateway forward node connection max size"
  val GatewayMaxRequestPerClusterPropDoc = "gateway forward request max size"
  ...
  val SaslCheckHostnameEnableDoc = "Enable check sasl client authenticator whit hostname, usually only in kerberos."
  ...
  private val configDef = {
    ...
    new ConfigDef()
      ...
      /** ********* didi Configuration ***********/
      .define(GatewayUpdateIntervalProp, LONG, "3600000", MEDIUM, GatewayUpdateIntervalPropDoc)
      .define(GatewayMaxNodeConnectionProp, INT, "10", MEDIUM, GatewayMaxNodeConnectionPropDoc)
      .define(GatewayMaxRequestPerClusterProp, INT, "1000", MEDIUM, GatewayMaxRequestPerClusterPropDoc)
      ...
      .define(MaxThrottleTimeMsProp, INT, 10000, MEDIUM, "")
      .define(TransmitTimeoutMsProp, INT, 10000, MEDIUM, "")
      .define(SaslCheckHostnameEnableProp, BOOLEAN, true, LOW, SaslCheckHostnameEnableDoc)
...
class KafkaConfig(val props: java.util.Map[_, _], doLog: Boolean, dynamicConfigOverride: Option[DynamicBrokerConfig])
  ...
  val gatewayUpdateInterval: Long = getLong(KafkaConfig.GatewayUpdateIntervalProp)
  val gatewayMaxNodeConnection: Int = getInt(KafkaConfig.GatewayMaxNodeConnectionProp)
  val gatewayMaxRequestPerCluster: Int = getInt(KafkaConfig.GatewayMaxRequestPerClusterProp)
  ...
  var transmitTimeoutMs: Int = getInt(KafkaConfig.TransmitTimeoutMsProp)
