 ...
 */
public class MirrorConfig extends AbstractConfig {
    ...
    public MirrorConfig(Properties props) {
        super(CONFIG, props);
    }

    public MirrorConfig(Map<String, Object> props) {
        super(CONFIG, props);
    }

    protected MirrorConfig(Map<?, ?> props, boolean doLog) {
