...
CREATE TABLE `ks_km_broker` (
  ...
  `rack` varchar(64) NOT NULL DEFAULT '' COMMENT 'Rack信息',
...
CREATE TABLE `ks_km_cluster_balance_job` (
  ...
  `topic_black_list` varchar(256) NOT NULL DEFAULT '' COMMENT 'topic黑名单',
  ...
  `move_in_topic_list` varchar(256) NOT NULL DEFAULT '' COMMENT '移入topic',
  `move_broker_list` varchar(256) NOT NULL DEFAULT '' COMMENT '移除节点',
...
CREATE TABLE `ks_km_job` (
  ...
  `job_name` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '任务名称',
